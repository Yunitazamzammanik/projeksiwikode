        ...
        <div class="wrap card">
        	<section class="app-content">
        		<div class="row">
        			...
        			<div class="col-lg-12">
        				<form action="<?php echo base_url('profesi/update'); ?>" class="form-horizontal" method="POST">
                        
                            <div class="form-group">
        						<label for="nama" class="col-sm-3">Nama</label>
        						<div class="col-sm-12">
        							<input type="text" id="nama" class="form-control" placeholder="Masukan Nama" name="nama"  value="<?= $profesi->nama?>" required>
        						</div>
